...
file = "./output/log_eeg_tradi_theta_LinearDiscriminantAnalysis"
...
file = "./output/log_eeg_tradi_theta_32channels_LinearDiscriminantAnalysis"
pickle_in = open(file +".pickle", "rb")
...
file = "./output/log_eeg_tradi_alpha_LinearDiscriminantAnalysis"
pickle_in = open(file +".pickle", "rb")
...
file = "./output/log_eeg_tradi_alpha_32channels_LinearDiscriminantAnalysis"
pickle_in = open(file +".pickle", "rb")
...
file = "./output/log_eeg_tradi_beta_LinearDiscriminantAnalysis"
pickle_in = open(file +".pickle", "rb")
...
file = "./output/log_eeg_tradi_beta_32channels_LinearDiscriminantAnalysis"
pickle_in = open(file +".pickle", "rb")
...
file = "./output/log_eeg_tradi_gamma_LinearDiscriminantAnalysis"
pickle_in = open(file +".pickle", "rb")
...
file = "./output/log_eeg_tradi_gamma_32channels_LinearDiscriminantAnalysis"
pickle_in = open(file +".pickle", "rb")
...
file = "./output/log_eeg_tradi_4bands_LinearDiscriminantAnalysis"
pickle_in = open(file +".pickle", "rb")
...
file = "./output/log_eeg_tradi_4bands_32channels_LinearDiscriminantAnalysis"
pickle_in = open(file +".pickle", "rb")
...
file = "./output/log_eeg_tradi_csp_theta_20channels"
pickle_in = open(file +".pickle", "rb")
...
file = "./output/log_eeg_tradi_csp6_theta_20channels"
pickle_in = open(file +".pickle", "rb")
...
file = "./output/log_eeg_tradi_csp_theta"
pickle_in = open(file +".pickle", "rb")
...
file = "./output/log_eeg_tradi_csp6_theta"
pickle_in = open(file +".pickle", "rb")
...
file = "./output/log_eeg_tradi_csp_alpha_20channels"
pickle_in = open(file +".pickle", "rb")
...
file = "./output/log_eeg_tradi_csp_alpha"
pickle_in = open(file +".pickle", "rb")
...
file = "./output/log_eeg_tradi_csp6_alpha"
pickle_in = open(file +".pickle", "rb")
...
file = "./output/log_eeg_tradi_csp_beta_20channels"
pickle_in = open(file +".pickle", "rb")
...
file = "./output/log_eeg_tradi_csp6_beta_20channels"
pickle_in = open(file +".pickle", "rb")
...
file = "./output/log_eeg_tradi_csp_beta"
pickle_in = open(file +".pickle", "rb")
...
file = "./output/log_eeg_tradi_csp6_beta"
pickle_in = open(file +".pickle", "rb")
...
file = "./output/log_eeg_tradi_csp_gamma_20channels"
pickle_in = open(file +".pickle", "rb")
...
file = "./output/log_eeg_tradi_csp6_gamma_20channels"
pickle_in = open(file +".pickle", "rb")
...
file = "./output/log_eeg_tradi_csp_gamma"
pickle_in = open(file +".pickle", "rb")
...
file = "./output/log_eeg_tradi_csp6_gamma"
pickle_in = open(file +".pickle", "rb")
...
file = "./output/log_eeg_tradi_csp_4bands_20channels"
pickle_in = open(file +".pickle", "rb")
...
file = "./output/log_eeg_tradi_csp6_4bands_20channels"
pickle_in = open(file +".pickle", "rb")
...
file = "./output/log_eeg_tradi_csp_4bands"
pickle_in = open(file +".pickle", "rb")
...
file = "./output/log_eeg_tradi_csp6_4bands"
pickle_in = open(file +".pickle", "rb")
...
ax.set(xlabel='band', ylabel='EEG Accuracy (TRADI)')
